...
def generate_launch_description():
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument("base_frame", default_value="base_link", description="Name of frame in which the positions of detected objects is expressed.\n" \
        "Requires a calibrated transform from base_link to the camera frame on real hardware."),
